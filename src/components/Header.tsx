    ...
    <header className="sticky top-0 z-50 border-b border-brass/30 bg-espresso/95 backdrop-blur supports-[backdrop-filter]:bg-espresso/90 relative">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-4 lg:px-10">
        <Link href="#top" className="flex shrink-0 items-center gap-3">
          ...
          />
          <span className="hidden border-l border-brass/40 pl-3 font-body text-xs leading-tight text-blush/70 sm:block">
            Engenharia de
            <br />
            Conformidade Predial
          </span>
        </Link>
        ...
        <div className="flex shrink-0 items-center gap-4">
          <WhatsAppLink
            ...
            className="rounded-full bg-rose px-5 py-2.5 font-body text-sm font-medium text-espresso transition-colors hover:bg-rose-strong"
          >
            Analisar meu imóvel
          </WhatsAppLink>
          <MobileNav />
